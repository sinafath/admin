...
import { productType } from '@/app/_libs/products/types';
...
export function ProductComboBox({data}:ProductComboBoxProps) {
    ...
    const { value , onChange, onBlur, onFocus, ...props } = form.getInputProps('productId')
